...
--Addon LAM menu
	...
	SI_ARC_LAM_OPTION_AUTO_RECHARGE_DELAY				= GetString(SI_CHARGE_WEAPON_TITLE) .. " Verzögerung",
	SI_ARC_LAM_OPTION_AUTO_RECHARGE_DELAY_TT			= "Mit diesem Zeit Wert in Millisekunden (ms) zwischen jedem " .. GetString(SI_CHARGE_WEAPON_TITLE) .." Versuch -> Verhindere, dass der Server dich wegen Nachrichten-Spam vom Server wirft!\nAbhängig von der Anzahl der aktivierten AddOns, der Anzahl der spielenden Spieler, der Serverlast durch aktive Events etc., musst du diese Nummer ggf. höher einstellen!",
	SI_ARC_LAM_OPTION_AUTO_REPAIR_DELAY					= GetString(SI_ITEM_FORMAT_STR_ARMOR) .." Verzögerung",
	SI_ARC_LAM_OPTION_AUTO_REPAIR_DELAY_TT				= "Mit diesem Zeit Wert in Millisekunden (ms) zwischen jedem " .. GetString(SI_ITEM_FORMAT_STR_ARMOR) .." Versuch -> Verhindere, dass der Server dich wegen Nachrichten-Spam vom Server wirft!\nAbhängig von der Anzahl der aktivierten AddOns, der Anzahl der spielenden Spieler, der Serverlast durch aktive Events etc., musst du diese Nummer ggf. höher einstellen!",
