local strings = {
--Addon LAM menu
	SI_ARC_LAM_ADDON_DESC								= "Перезаряжает и ремонтирует ваше экипированое оружие и броню автоматически до входа и после выходе из боя.",
	...
	SI_ARC_LAM_OPTION_SUPPRESS_CHAT_MSG_NOTHING			= "      Подавлять сообщения \'Нечего ...\'",
	...
	SI_ARC_LAM_OPTION_ALERT_SOON_EMPTY_REPAIRKIT		= "Показывать \'Ремонтные наборы скоро закончатся\'",
	SI_ARC_LAM_OPTION_ALERT_SOON_EMPTY_REPAIRKIT_TT		= "Показывает на экране предупреждающее сообщение если количество ваших ремонтных наборов падает ниже порогового значения.\n\nУстановите ваш порог на ползунке справа!",
