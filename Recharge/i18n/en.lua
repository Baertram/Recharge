...
--Addon LAM menu
	...
	SI_ARC_LAM_OPTION_AUTO_RECHARGE_DELAY				= "Recharge delay",
	SI_ARC_LAM_OPTION_AUTO_RECHARGE_DELAY_TT			= "With this time in milliseconds (ms) between each recharge try -> avoid getting kicked for spamming the server!\nDepending on your enabled amount of addons, gaming time, server stress due to active events and many players playing you max need to increase this number!",
	SI_ARC_LAM_OPTION_AUTO_REPAIR_DELAY					= "Repair delay",
	SI_ARC_LAM_OPTION_AUTO_REPAIR_DELAY_TT				= "With this time in milliseconds (ms) between each repair try -> avoid getting kicked for spamming the server!\nDepending on your enabled amount of addons, gaming time, server stress due to active events and many players playing you max need to increase this number!",
