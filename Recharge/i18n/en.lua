...
--Addon LAM menu
	...
	SI_ARC_LAM_OPTION_ALERT_EMPTY_SOULGEM				= "Shows '" .. GetString(SI_CUSTOMERSERVICESUBMITFEEDBACKSUBCATEGORIES406) .. " empty' alert",
	SI_ARC_LAM_OPTION_ALERT_EMPTY_SOULGEM_TT			= "Shows onscreen alert message if your Soul gems are empty",
	SI_ARC_LAM_OPTION_ALERT_SOON_EMPTY_SOULGEM			= "Shows '" .. GetString(SI_CUSTOMERSERVICESUBMITFEEDBACKSUBCATEGORIES406) .. " empty soon' alert",
	...
	SI_ARC_LAM_OPTION_ALERT_EMPTY_SOULGEM_TH			= GetString(SI_CUSTOMERSERVICESUBMITFEEDBACKSUBCATEGORIES406) .. " threshold",
	...
	SI_ARC_LAM_OPTION_ALERT_EMPTY_SOULGEM_LOGIN	  		= "Shows '" .. GetString(SI_CUSTOMERSERVICESUBMITFEEDBACKSUBCATEGORIES406) .. "' alert at login/reloadui",
	SI_ARC_LAM_OPTION_ALERT_EMPTY_SOULGEM_LOGIN_TT		= "As you login or do a reloadui:\nShow onscreen alert message if your " .. GetString(SI_CUSTOMERSERVICESUBMITFEEDBACKSUBCATEGORIES406) .. " amount drops below the chosen threshold or is already 0.",
...
--Chat output messages
    ...
    SI_ARC_CHATOUPUT_SOULGEMS_EMPTY_THRESHOLD			= GetString(SI_CUSTOMERSERVICESUBMITFEEDBACKSUBCATEGORIES406) .." empty threshold: ",
...
--Alert messages
	...
	SI_ARC_ALERT_SOULGEMS_EMPTY							= GetString(SI_CUSTOMERSERVICESUBMITFEEDBACKSUBCATEGORIES406) .. " are empty!",
	SI_ARC_ALERT_SOULGEMS_SOON_EMPTY					= GetString(SI_CUSTOMERSERVICESUBMITFEEDBACKSUBCATEGORIES406) .. " are empty soon! Only <<C:1>> left!",
